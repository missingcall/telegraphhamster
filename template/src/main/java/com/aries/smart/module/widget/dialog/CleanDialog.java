...
public class CleanDialog extends CommonDialog {
    ...
    public CleanDialog(Context context, int themeResId) {
        super(context, themeResId);
        initView(context);
    }

    public CleanDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
        initView(context);
    }

    public CleanDialog(Context context, float alpha, int gravity) {
