...
import com.aries.smart.module.widget.CenterImageSpan;
import com.aries.smart.module.widget.MyLeadingMarginSpan2;
...
//                mBuilder.setSpan(new LeadingMarginSpan.Standard(first, rest), start, end, flag);
                mBuilder.setSpan(new MyLeadingMarginSpan2(first, rest), start, end, flag);
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(new CenterImageSpan(App.getInstance(), bitmap, ImageSpan.ALIGN_BASELINE), start, end, flag);
                    bitmap = null;
                    imageIsBitmap = false;
